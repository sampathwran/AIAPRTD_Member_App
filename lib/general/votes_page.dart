                              ...
                              ...List.generate(options.length, (index) {
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: selectedOption == index ? Colors.blue.withOpacity(0.1) : Colors.transparent,
                                  ),
                                  child: ListTile(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: isMyComment ? Colors.blue.withOpacity(0.05) : (isDark ? Colors.grey.shade800 : Colors.grey.shade50), 
                                            borderRadius: BorderRadius.circular(16),
                                            border: isMyComment ? Border.all(color: Colors.blue.withOpacity(0.2)) : null,
                                          ),
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
            ...
            itemBuilder: (context, index) {
              ...
              if (expiryDate != null) {
                ...
                if (diff.isNegative) {
                  ...
                  timeStatusBgColor = Colors.red.withOpacity(0.1);
                  ...
                  timeStatusBgColor = Colors.orange.withOpacity(0.1);
                } else {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(color: isDark ? Colors.black26 : Colors.black.withOpacity(0.04), blurRadius: 10, offset: const Offset(0, 4)),
                    ],
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
