...
class _FaceVerificationPageState extends State<FaceVerificationPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // 💡 ලේසර් ස්කෑනර් ලයින් එකේ ඇනිමේෂන් එක
  ...
  Future<void> _startAIScan() async {
    ...
    // ලේසර් එක උඩට පල්ලෙහාට යන්න පටන් ගන්නවා
    _scannerController.repeat(reverse: true);

    // 💡 AI ලොග් එක එකින් එක මාරු කරනවා (බොරු AI ලුක් එක)
    for (int i = 1; i < 6; i++) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF020611), // 💡 තද කළු/නිල් පාටක් (Hacker look)
      body: SafeArea(
        child: Column(
          children: [
            // ==========================================
              ...
              child: Center(
                child: _isCameraInitialized && _cameraController != null
                  ...
                  children: [
                    ...
                    // 💡 ලේසර් ස්කෑනර් ලයින් එක (Scan වෙද්දි විතරක් පේනවා)
                    if (_isScanning)
                      AnimatedBuilder(
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color: _isScanning ? Colors.greenAccent : Colors.cyanAccent,
                          fontFamily: 'Courier', // 💡 හැකර් Terminal එකක අකුරු ජාතිය
