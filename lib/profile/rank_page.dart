...
class RankPage extends StatefulWidget {
  final Map<String, dynamic> memberData; // 💡 මෙම්බර්ගේ ඩේටා බාරගන්නවා
...
class _RankPageState extends State<RankPage> {
  ...
  // 💡 🎯 මෙම්බර්ගේ දැනට තියෙන තත්ත්වය ගණනය කිරීම
  void _calculateCurrentStats() {
    ...
    // ට්‍රිප් ගාණ (Rides - ඩේටාබේස් එකේ 'tripCount' තියෙනවා යැයි උපකල්පනය කර ඇත)
    currentRides = int.tryParse(data['tripCount']?.toString() ?? '0') ?? 0;
  }

  // 💡 🎯 එක් එක් සුදුසුකමට අදාළව 100% න් කොච්චර සම්පූර්ණදැයි සෙවීම
  double _calculateProgress(String type, dynamic target) {
    if (target == 0) return 1.0; // ටාගට් එකක් නැත්නම් 100% යි
    ...
    switch (type) {
      ...
      case 'binary':
        return 1.0; // දැනට 100% ලෙස සලකයි (උදා: Fees Paid)
      default:
        return 0.0;
    }
  }
                    ...
                    children: [
                      ...
                      _buildSection(
                          ...
                          (rank['criteria'] as List).map((c) {
                            // 💡 🎯 එක් එක් Criteria එකට අදාළ Progress එක ගණනය කර යැවීම
  ...
  // සාමාන්‍ය Benefits සඳහා Tile එක (Progress නැත)
  ...
  // 💡 🎯 අලුත් Tile එක (සුදුසුකම් වල Progress Bar එක පෙන්වීමට)
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        // 100% නම් Completed කියලත්, නැත්නම් % එකත් වැටෙනවා
                        Text(
