...
class TermsConditionsPage extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionCard(
              ...
              content:
                  "By activating and using the AIAPRTD Member App, you agree to comply with and be bound by these comprehensive terms and conditions, as well as the organizational bylaws of AIAPRTD. If you do not agree with any part of these terms, you should immediately cease using this application.",
            ),
            ...
            _buildSectionCard(
              ...
              content:
                  "AIAPRTD reserves the right to modify these terms periodically. Continued use implies consent to any revisions. For inquiries, you may contact us via:\n\nEmail: info@aiaprtd.lk\nPhone: 0705001002, 0775018681",
            ),
  ...
  Widget _buildSectionCard({
    ...
    final titleColor =
        isWarning ? Colors.redAccent : theme.colorScheme.onSurface;

    return Container(
      decoration: BoxDecoration(
        color: isDark
            ? const Color(0xFF1E1E2C)
            : (isWarning ? Colors.red.withValues(alpha: 0.02) : Colors.white),
