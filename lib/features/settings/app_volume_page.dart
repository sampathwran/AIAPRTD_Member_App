...
class _AppVolumePageState extends State<AppVolumePage> {
  ...
  void _testAudio(double volume) {
    ...
    _audioPlayer.play(
        AssetSource('sounds/intro.mp3')); // Using intro.mp3 as a test sound
  }
            ...
            _buildSection(
              ...
              [
                ListTile(
                  ...
                  title: Text("Current Battery Level",
                      style: TextStyle(
                          fontSize: 14,
                ...
                SwitchListTile(
                  ...
                  onChanged: (val) {
                    ...
                    if (val && _batteryLevel <= 20) {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text("Warning: Battery is currently low!"),
                  ...
                  title: Text("Low Battery Warning",
                      style: TextStyle(
                          ...
                          color: isDarkMode ? Colors.white : Colors.black87)),
                  subtitle: const Text(
                      "Get an alert when battery drops below 20%",
            ...
            _buildSection(
              ...
              [
                SwitchListTile(
                  ...
                  title: Text("Seatbelt Audio Message",
                      style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
                          color: isDarkMode ? Colors.white : Colors.black87)),
                  subtitle: const Text(
                      "Play a safety reminder audio when you start a trip.",
                      style: TextStyle(fontSize: 11)),
                  activeColor: Colors.blue,
                ),
              ],
