...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFF8FAFC), // Beautiful Off-White background
      appBar: AppBar(
        title: const Text(
          'Privacy Policy',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Header Icon and description at the top
            Center(
              child: Column(
                children: [
                  Container(
            ...
            // 📄 Section 4: Data Security Card (Put inside a Card as it's important info)
            ...
            Card(
              ...
              child: const Padding(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Icon(Icons.lock_person_outlined, color: Colors.green, size: 28),
                    SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
