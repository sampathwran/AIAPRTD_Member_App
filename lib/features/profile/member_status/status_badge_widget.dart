    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (membershipNo != null && membershipNo.trim().isNotEmpty) {
        Provider.of<PaymentProvider>(context, listen: false)
            .streamPaymentData(membershipNo)
            .listen((_) {});
    ...
    return Consumer2<PaymentProvider, VehicleProvider>(
      builder: (context, paymentProvider, vehicleProvider, child) {
        ...
        final String currentDataHash =
            '${evaluationData['payment_history']}_${evaluationData['documents']}_${evaluationData['vehiclePhotos']}_${evaluationData['kycApprovalStatus']}_${evaluationData['faceKycStatus']}_${evaluationData['profileImageUrl']}_${evaluationData['adminBlockStatus']}';
        ...
        return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            if (!widget.isProfileView && !isInactive)
              return const SizedBox.shrink();
