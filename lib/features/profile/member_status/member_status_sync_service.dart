...
class MemberStatusSyncService {
  ...
  static Future<void> syncStatusToFirestore(Map<String, dynamic> memberData,
    ...
    try {
      ...
      final Map<String, dynamic> statusResult =
          calculateMemberStatus(memberData);
      final bool isActive = statusResult['isActive'] == true;
      final List<String> reasons = (statusResult['reasons'] as List<dynamic>?)
              ?.map((e) => e.toString())
              .toList() ??
          [];
      ...
      final String blockReason =
          memberData['adminBlockReason']?.toString() ?? '';
      ...
      debugPrint(
          '✅ Member status successfully synced for $id. Active: $isActive');
    } catch (e) {
