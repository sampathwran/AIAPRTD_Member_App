...
class _VotesPageState extends State<VotesPage> {
  ...
  void _submitComment(
      String pollId, String text, String memberName, String memberId) async {
                                    ...
                                    title: Text(options[index].toString(),
                                        style: TextStyle(
                                            color: isDark
                                                ? Colors.white
                                                : Colors.black87,
                                            fontWeight: selectedOption == index
                                                ? FontWeight.bold
                                                : FontWeight.normal)),
                                    leading: Radio<int>(
                                      value: index,
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text("Check back later for new voting events.",
                      style: TextStyle(
            ...
            itemBuilder: (context, index) {
              ...
              if (expiryDate != null) {
                ...
                if (diff.isNegative) {
                  ...
                  timeStatusText =
                      "Ends: ${DateFormat('MMM dd, hh:mm a').format(expiryDate)}";
                  timeStatusColor =
              ...
              return GestureDetector(
                onTap: () => _showPollDetailsSheet(context, data, doc.id,
                    memberId, memberName, memberNo, memberPhone, isDark, theme),
                child: Container(
                      ...
                      Wrap(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(isExpired ? "Closed" : "Active Poll",
                                style: TextStyle(
                          ...
                          if (timeStatusText.isNotEmpty)
                            Container(
                              padding: EdgeInsets.symmetric(
                                  horizontal:
                                      timeStatusBgColor == Colors.transparent
                                          ? 0
                                          : 8,
                                  vertical: 4),
                              decoration: BoxDecoration(
