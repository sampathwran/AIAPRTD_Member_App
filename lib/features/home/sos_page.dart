...
class _SosPageState extends State<SosPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Community Assistance",
            ...
            children: [
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSelected =
                      assistanceProvider.selectedIssue == issue['title'];
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              color:
                                  isSelected ? issue['color'] : Colors.black87,
              ...
              if (assistanceProvider.isSubmitting)
                const Column(
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text("Sending request to nearby drivers...",
                ...
                GestureDetector(
                  ...
                  onLongPressEnd: (_) async {
                    bool success = await assistanceProvider
                        .stopRecordingAndSubmit(profileProvider);
                    if (success && context.mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                        content: Text(
                            "Help request sent! Waiting for a nearby driver to accept."),
                        ...
                        return Container(
                          ...
                          child: Center(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(isRec ? Icons.mic : Icons.mic_none,
