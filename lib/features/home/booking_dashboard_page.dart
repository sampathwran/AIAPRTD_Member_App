...
import 'package:aiaprtd_member/features/home/scheduled_bookings_tab.dart';
import 'package:aiaprtd_member/features/home/live_bookings_tab.dart';
...
class _BookingDashboardPageState extends State<BookingDashboardPage> {
  double _searchRadiusKm = 20.0; // Default 20km
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              title: Text('profile.hires_dashboard'.tr(),
                  style: TextStyle(
