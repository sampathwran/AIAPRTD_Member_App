...
class LiveBookingsTab extends StatefulWidget {
...
class _LiveBookingsTabState extends State<LiveBookingsTab> {
  ...
  @override
  void didUpdateWidget(LiveBookingsTab oldWidget) {
  ...
  void _showInactiveWarning(BuildContext context, String reason) {
    showModalBottomSheet(
      context: context,
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(top: Radius.circular(20)),
