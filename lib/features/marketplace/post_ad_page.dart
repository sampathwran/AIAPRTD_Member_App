                          ...
                          StreamBuilder<cloud_firestore.QuerySnapshot>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                _firebaseCategories = snapshot.data!.docs
                                    ...
                                    .toList();
                                _firebaseCategories.sort((a, b) =>
                                    (a['order'] ?? 999)
                                        .compareTo(b['order'] ?? 999));

                                if (_selectedCategory != null &&
                                    !_firebaseCategories.any((c) =>
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: const Padding(
                                ...
                                child:
                                    Icon(Icons.subject, color: Colors.blueGrey),
                              ),
                              filled: true,
                              fillColor: fillColor,
                              border: OutlineInputBorder(
                            ...
                            child: ClipRRect(
                              ...
                              child: GoogleMap(
                                initialCameraPosition: CameraPosition(
                                    target: LatLng(_lat ?? 6.9271,
                                        _lng ?? 79.8612), // Default Colombo
                                    zoom: 12),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: SwitchListTile(
                              ...
                              subtitle: const Text(
                                  "Let buyers place bids on your item",
