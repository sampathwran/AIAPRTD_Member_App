...
import 'package:aiaprtd_member/features/marketplace/ad_chat_page.dart';
...
class _AdDetailsPageState extends State<AdDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    try {
      formattedPrice =
          NumberFormat.decimalPattern().format(double.parse(priceStr));
    } catch (_) {}
                  ...
                  _buildContactBtn(Icons.wechat, "WhatsApp", Colors.teal, () {
                    FirebaseFirestore.instance
                      ...
                      if (doc.exists && doc.data()?['whatsapp'] != null) {
                        ...
                        launchUrl(Uri.parse(
                            "https://wa.me/$phone?text=Hi, I am interested in your ad: $title"));
                      }
                    });
                  }),
                ],
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          var bid = snapshot.data!.docs[index].data()
                          ...
                          return ListTile(
                            leading: CircleAvatar(
                                ...
                                child: const Icon(Icons.person,
                                    color: Colors.orange)),
                            title: Text(bid['bidderName'] ?? 'Member',
                                style: const TextStyle(
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text("LKR ${bid['amount']}",
                                style: const TextStyle(
                                    color: Colors.green,
                                    fontWeight: FontWeight.bold)),
                          );
