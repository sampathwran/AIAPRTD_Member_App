...
import 'package:aiaprtd_member/providers/theme_provider.dart';
import 'package:aiaprtd_member/providers/earnings_provider.dart';
import 'package:aiaprtd_member/providers/profile_provider.dart';
import 'widgets/earning_summary_card.dart';
import 'widgets/earning_trip_tile.dart';
...
class _EarningsPageState extends State<EarningsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = isDark ? const Color(0xff0A192F) : Colors.grey.shade50;
    final textColor = isDark ? Colors.white : const Color(0xff1B2735);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          // Refresh Button එක ආයෙත් දැම්මා
          IconButton(
            ...
            children: [
              ...
              Expanded(
                child: RefreshIndicator(
                  // Pull to refresh එක ආයෙත් වැඩ කරන විදියට හැදුවා
                  onRefresh: () async {
                    final profileProvider = Provider.of<ProfileProvider>(context, listen: false);
                    if (profileProvider.memberNo != 'N/A') {
  ...
  Widget _buildFilterChip(String label, bool isDark) {
    ...
    final selectedColor = isCancelledTab
        ? Colors.red.shade400
        : (isDark ? Colors.blue.shade400 : const Color(0xff1B2735));

    final unselectedColor = isDark ? const Color(0xff1B2735) : Colors.white;
